...
class Geometry
{
	double PI = 3.142;
    double area; 
    int ch, length, breadth, height, side, diagonal1, radius, diagonal2;
	...
	void Triangle(Scanner sc)
	{
	    ...
	    System.out.println("Area of the Triangle with height "+height+" and breadth "+breadth+ " is= " + area+"\n\n");  
	}
	...
	void sphere(Scanner sc)
	{
		...
		System.out.println("Area of sphere with "+radius+" is = "+area+ "\n"); 
	...
	void Cylinder(Scanner sc)
	{
		...
		System.out.println("Area of Cylinder with radius "+radius+" and height "+height+" is= "+area2 + "\n\n");
	}
}
...
class MenuArea
{
	void show1(Scanner sc)
	{
	 ...
	 Geometry obj = new Geometry();
        ...
        int x = sc.nextInt();
		switch(x){
	       case 1: obj.Circle(sc);
		   break;
		   case 2: obj.Rectangle(sc);
		   break;
		   case 3: obj.Triangle(sc);
		   break;
		   case 4: obj.Square(sc);
		   break;
		   case 5: obj.sphere(sc);
		   break;
		   case 6: obj.Cylinder(sc);
		   break;
		   case 7:
		   break k;
	   }
